...
import xyz.dsvshx.collie.agent.config.AgentConfigHolder;
...
public class CollieAgent {
    ...
    public static void premain(String agentOps, Instrumentation instrumentation) {
        try {
            ...
            // 使用自定义的类加载器加载core包
            CollieClassLoader collieClassLoader = new CollieClassLoader(new URL[] {agentCoreFile.toURI().toURL()});

            // addTransformer
            Class<?> collieClassFileTransformer =
                    collieClassLoader.loadClass("xyz.dsvshx.collie.core.instrumentation.CollieClassFileTransformer");
