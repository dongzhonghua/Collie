...
import xyz.dsvshx.collie.core.aspect.FrameworkCallListener;
import xyz.dsvshx.collie.core.aspect.LogAspectImpl;
import xyz.dsvshx.collie.core.aspect.MethodCallLisener;
    ...
    private byte[] transformClass(String className, byte[] classfileBuffer) {
        try {
            ...
            for (CtBehavior ctBehavior : ctClass.getDeclaredBehaviors()) {
                ...
                // 打点加到最后
                ctBehavior.insertAfter(
                        "{xyz.dsvshx.collie.point.Point.point(\"" + methodId
